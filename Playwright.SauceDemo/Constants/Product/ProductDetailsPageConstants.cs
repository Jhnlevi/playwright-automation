namespace Playwright.SauceDemo.Constants.Product
{
   internal class ProductDetailsPageConstants
   {
      ...
      public const string PRODUCT_DETAILS_DESC_NAME = "product-details-desc-name";
      public const string PRODUCT_DETAILS_DESC_DESCRIPTION = "product-details-desc-description";
