namespace Playwright.Parabank.Constants.Public
{
   internal class LoginPageConstants
   {
      ...
      public const string LOGIN_FORGOT_LOGIN_INFO = "login-forgot-login-info";
      public const string LOGIN_REGISTER_BUTTON = "login-register-button";
      public const string LOGIN_LEFT_PANEL = "login-left-panel";
      public const string LOGIN_RIGHT_PANEL = "login-right-panel";
   }
}
